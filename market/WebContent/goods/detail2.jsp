...
PreparedStatement stmt=conn.prepareStatement("insert into undealorder(orderID,goodsID,quantity,loginName,goodsType) values(?,?,?,?,?)",ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
...
stmt.close();
conn.close();
out.print("<script language='javascript'>alert('未完成订单处理完成');window.location.href='undeal.jsp';</script>");
%>
</body>
</html>