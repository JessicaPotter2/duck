...
<sql:query sql="select * from goodsorderinfo where ispaied='paied'" var="order" />
<sql:query sql="select * from orderdetail" var="detail" />
<center>
<form name="setform" action="dealit.jsp" method="post">
<p>
...
<tr>
<td><c:out value="${orderdetail.loginName}"/></td>
